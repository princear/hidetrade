...
const KindOfPreservationSellLeather = (props) => {
    ...
    <View style={{ flex: 1, backgroundColor: "white" }}>
      ...
      <ScrollView>
        <View style={{ marginHorizontal: 10 }}>
          ...
          >
            What kind of preservation have the leathers you wanna sell?
          </Text>
        ...
        <View style={{ flexDirection: "row", marginBottom: 15 }}>
          ...
          >
            <TouchableOpacity
              ...
              //       props.navigation.navigate("OriginBuyLeatherSearchProduct", {
...
export default KindOfPreservationSellLeather;
