...
const GoodsInspectionSellLeather = (props) => {
  const data = [
    { id: "1", value: "Yes" },
    { id: "2", value: "No" },
  ];
  ...
  console.log("🚀 ~ file: GoodsInspectionSellLeather.js ~ line 44 ~ GoodsInspectionSellLeather ~ origin", origin)
  var continent=props.route.params.continent
  console.log("🚀 ~ file: GoodsInspectionSellLeather.js ~ line 46 ~ GoodsInspectionSellLeather ~ continent", continent)
        ...
        <View style={{ flexDirection: "row", marginBottom: 15 }}>
          ...
          >
            <TouchableOpacity
              ...
              // onPress={() =>
              //   props.navigation.navigate("PutUpForSale",{productName:productName, category:category, subCategory:subCategory, size:size,leatherCondition:leatherCondition, tanningLeather:tanningLeather,substanceThickness:substanceThickness, fromValue:fromValue, toValue:toValue, destination:destination, trim:trim, flay:flay, rawDefects:rawDefects, hairLeather:hairLeather, color:color, certificate:certificate, kindOfPacking:kindOfPacking, kindOfShipment:kindOfShipment, lastInfo:lastInfo,goodsInspection:selected})
              // }
              onPress={() => {
...
export default GoodsInspectionSellLeather;
