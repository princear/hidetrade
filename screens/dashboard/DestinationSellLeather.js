...
const DestinationSellLeather = (props) => {
  const [destination, setDestination] = useState(undefined);
  const [selected, setSelected] = useState([]);
  const [dataLoad, setDataloaded] = useState(false);
  const [apiLoader, setApiLoader] = useState(true);
  console.log("🚀 ~ file: DestinationSellLeather.js ~ line 22 ~ DestinationSellLeather ~ apiLoader",props.route.params.Specification )
  ...
  console.log('label selection2='+labelSelection2)
...
console.log('origin',origin)
  // console.log('from value='+parseFloat(fromValue).toFixed(2))

  useEffect(() => {
    if(dataLoad==false){
      setApiLoader(true)
      let webApiUrl = `https://refuel.site/projects/hidetrade/APIs/ViewAllWhichDestinationHaveLeatherList/ViewAllWhichDestinationHaveLeatherList.php`;
    ...
    <View style={{ flex: 1, backgroundColor: "white" }}>
      ...
      <ScrollView>
        <View style={{ marginHorizontal: 10, marginTop: 10 }}>
          ...
          >
            Which destination are the leathers you are selling good for?
          </Text>
          <FlatList
            data={destination}
        ...
        <View style={{ flexDirection: "row", marginBottom: 15 }}>
          ...
          >
            <TouchableOpacity
              ...
              // onPress={() => props.navigation.navigate("KindOfTrimSellLeather",{productName:productName, category:category, subCategory:subCategory, size:size,leatherCondition:leatherCondition, tanningLeather:tanningLeather,substanceThickness:substanceThickness, fromValue:fromValue, toValue:toValue, destination:selected})}
              onPress={() => {
...
export default DestinationSellLeather;
