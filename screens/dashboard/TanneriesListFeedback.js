...
const TanneriesListFeedback = (props) => {
            ...
            {loading == false ? (
              <View>
                <TextInput
                  ...
                  mode="outlined"
                  label={"Search"}
                  style={{ backgroundColor: "white", height: 45, fontSize: 16 }}
                ...
                <FlatList
                  ...
                  renderItem={({ item }) => (
                    <TouchableOpacity
                      onPress={() =>
                        props.navigation.navigate("Tanneries Profile", {
...
export default TanneriesListFeedback;
