...
const CertificateLeatherSellLeather = (props) => {
    ...
    <View style={{ flex: 1, backgroundColor: "white" }}>
      ...
      <ScrollView>
        <View style={{ marginHorizontal: 10 }}>
          ...
          >
            What documents and certificates have the leather you wanna sell?
          </Text>
          <FlatList
            data={certificate}
      ...
      <View>
        ...
        >
          Upload the documents you own and want to share with other users
        </Text>
        <View style={{ flexDirection: "row", marginBottom: 15 }}>
          ...
          >
            <TouchableOpacity
              ...
              // onPress={() =>
              //   props.navigation.navigate("KindOfPackingSellLeather",{productName:productName, category:category, subCategory:subCategory, size:size,leatherCondition:leatherCondition, tanningLeather:tanningLeather,substanceThickness:substanceThickness, fromValue:fromValue, toValue:toValue, destination:destination, trim:trim, flay:flay, rawDefects:rawDefects, hairLeather:hairLeather, color:color, certificate:selected})
              // }
              onPress={() => {
                if (leatherCondition == "Raw") {
                  props.navigation.navigate("Packing Type", {
...
export default CertificateLeatherSellLeather;
